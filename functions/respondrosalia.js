...
exports.handler = async (event) => {
  ...
  // INTERNAL token required (default-deny) BEFORE method checks, body parsing, or any
  // business logic. Any legitimate caller (e.g. cincwebhook) must send X-Internal-Token.
