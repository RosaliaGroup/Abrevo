...
- Prices, availability, and incentives change daily ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â always note that the leasing agent will have the most current information at the tour
- Never confirm specific unit availability ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â say "subject to availability, our leasing agent will confirm at your tour"
- Anyone can schedule a tour regardless of credit score ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â never turn anyone away from touring
- Credit and income requirements are discussed with the leasing agent ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â not a barrier to touring
- Answer questions using the knowledge base, then redirect to booking the tour
- Keep replies concise ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â bullet points for Q&A, under 150 words
...
// Look up lead data from Supabase by email or name
...
// Look up upcoming calendar events by lead name
...
Write ONLY the email body. No subject line. Under 100 words. Use bullet points for Q&A answers. No markdown formatting ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â no **bold**, no *italic*. Never suggest specific times or availability.`;
  ...
  try {
    ...
    for (const raw of rawEmails) {
      try {
        ...
        // Look up lead in Supabase and Calendar for context
        ...
        if (calendarAppt) console.log('Calendar appointment found:', calendarAppt.title, calendarAppt.date, calendarAppt.time);
        if (leadContext) console.log('Lead context found:', leadContext.status, leadContext.phone);
        ...
        // Send email reply Ã¢â‚¬â€ use real lead email for Webflow/Avail, replyTo for others
