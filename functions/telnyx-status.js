 ...
 * operator session. Its authenticity gate is the Telnyx Ed25519 signature. It
 * also enforces POST-only and a bounded request size.
 */
...
const MAX_BODY = 256 * 1024; // bounded webhook size
